...
const Search = () => {
  ...
  const handleAddButton = async () => {
    ...
    let storedFoods = JSON.parse(localStorage.getItem("addedFoods")) || [];
    storedFoods.push(foodWithQuantity);
    localStorage.setItem("addedFoods", JSON.stringify(storedFoods));
  
    toast.success("✅ Food added successfully!");
  
    // Navigate to food_details
    setTimeout(() => {
